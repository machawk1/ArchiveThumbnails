$(document).ready(function(){
  ...
  for(var i=0; i<returnedJSON.length; i++){
    ...
    cfstr += "<img onError=\"this.onerror=null;checkAgainIfImageExists(this);this.src='http://localhost:1338/_images/spinner2.gif';\" width=200 height=200 src='http://localhost:1338/_images/spinner.gif' id='"+returnedJSON[i].screenshotURI.slice(0,-4)+"' title='http://localhost:1338/"+returnedJSON[i].screenshotURI+"' />\r\n";
